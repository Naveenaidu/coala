...
from coalib.nestedlib.NlFileHandler import (get_nl_file_dict, get_nl_sections,
    get_line_list, beautify_line_list, get_nl_file_dict )
...
class NlFileHandler(unittest.TestCase):
    ...
    def test_get_nl_file_dict(self):
        ...
        uut_file_dict = get_nl_file_dict(self.abs_test_file1_path, 
                        uut_temp_file_name, uut_lang, self.parser)
    ...
    def test_coala_setup_template(self):
        ...
        uut_test_file_path = os.path.join(self.file_test_dir, uut_test_filename)
        uut_abs_test_file_path = abspath(uut_test_file_path)
        uut_temp_file_name = 'test-setup-py.py.jj2.txt_nl_jinja2'


        temp_file_dict = get_nl_file_dict(uut_abs_test_file_path, uut_temp_file_name, 'jinja2',
            self.parser)
